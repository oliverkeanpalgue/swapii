        ...
        <div class="relative mb-6 overflow-hidden bg-white border shadow-md sm:rounded-md">
            <div class="p-6">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <div>
                        <InputLabel for="category" value="Category Name" class="text-sm font-medium text-gray-700 mb-1" />
                        <div class="relative">
                    ...
                    <div>
                        <InputLabel for="description" value="Description" class="text-sm font-medium text-gray-700 mb-1" />
                        <div class="relative">
                            <div class="absolute top-3 left-0 pl-3 flex items-start pointer-events-none">
                                <Icon icon="mdi:text-box-outline" class="h-5 w-5 text-gray-400" />
                            </div>
                            <textarea
                                id="description"
                                v-model="form.description"
                                class="pl-10 w-full rounded-md border border-gray-300 focus:ring-primary focus:border-primary bg-gray-50"
                                rows="4"
